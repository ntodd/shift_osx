...
*/
{
    ...
    if ( [panel runModal] == NSOKButton ) {
		...
		// mac os 10.4 or later
			[editData writeToFile:fileName atomically:YES encoding:[SMCPConnection encodingForMySQLEncoding:[[tableDocumentInstance getSelectedEncoding] UTF8String]]  error:errorStr];
		} else {
		// mac os pre 10.4
